        ...
        <div className="max-w-3xl mx-auto py-6 space-y-8 px-4">
            ...
            >
                ...
                <h1 className="text-2xl font-bold text-foreground mb-2">
                    Hey! I&apos;m <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">Drift</span>
                </h1>
            ...
            >
                <h2 className="text-sm font-semibold text-muted-foreground text-center mb-4 uppercase tracking-wider">What I can do</h2>
                <div className="grid grid-cols-3 md:grid-cols-6 gap-3">
                    {capabilities.map((cap, index) => (
                        ...
                        >
                            ...
                            <h3 className="text-xs font-medium text-foreground">{cap.title}</h3>
            ...
            >
                <h2 className="text-sm font-semibold text-muted-foreground text-center mb-4 uppercase tracking-wider">Quick Actions</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                    {quickActions.map((action, index) => (
                        <motion.button
                            ...
                            className="p-3 flex items-center space-x-3 text-left rounded-xl bg-card hover:bg-muted/50 border border-border transition-colors"
                        >
            ...
            >
                <h2 className="text-sm font-semibold text-muted-foreground text-center mb-4 uppercase tracking-wider">Try asking...</h2>
                <div className="flex flex-wrap justify-center gap-2">
                    {prompts.map((prompt, index) => (
                        <motion.button
                            ...
                            className="px-4 py-2 bg-muted/50 hover:bg-muted border border-border hover:border-primary/30 rounded-full text-sm text-muted-foreground hover:text-foreground transition-all"
                        >
                            &quot;{prompt}&quot;
                        </motion.button>
                    ))}
